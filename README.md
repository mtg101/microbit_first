...
Flashing: initially wasn't working. Output showed can't find 'ufs' command so I made a .bat file for it. But... it does try alternates like python3 and py so... maybe it was just in need of a reset not a batch file? Anyway got it working.
...
USB serial post debugging works when you select USB com port. I think that blocks the flashing, which maybe is why I made ufs.bat when it tries py later anyway...
